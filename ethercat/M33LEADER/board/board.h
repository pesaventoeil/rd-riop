...
#define BOARD_NAFE_DRDY_GPIO_MUX_CFG    IOMUXC_GPIO_B1_11_GPIO6_IO11
#define BOARD_NAFE_DRDY_FLEXIO_MUX_CFG  IOMUXC_GPIO_B1_11_GPIO6_IO11
#define BOARD_NAFE_DRDY_IRQN            GPIO6_IRQn
