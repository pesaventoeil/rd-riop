...
typedef enum
{
    kNafeDrdyPinSeqMode_onConversion = 0u,
    kNafeDrdyPinSeqMode_onSequencer
} NAFE_drdyPinSeqMode_t;

typedef enum
{
    kNafeInterrupt_spi = 0u,
    kNafeInterrupt_drdyPin
} NAFE_interruptSrc_t;
...
typedef enum
{
    kNafeChnGain_0p2x_cal = 0u,
    kNafeChnGain_0p4x_cal,
    kNafeChnGain_0p8x_cal,
    kNafeChnGain_1x_cal,
    kNafeChnGain_2x_cal,
    kNafeChnGain_4x_cal,
    kNafeChnGain_8x_cal,
    kNafeChnGain_16x_cal,
} NAFE_chnGainCal_t;
...
typedef enum
{
    kNafeNonBlockSampleState_initial = 0u,
    kNafeNonBlockSampleState_modeCmdSent,
    kNafeNonBlockSampleState_waitForReady,
    kNafeNonBlockSampleState_ready,
    kNafeNonBlockSampleState_rxClkSending,
    kNafeNonBlockSampleState_dataReceived,
    kNafeNonBlockSampleState_done,
} NAFE_nonBlockSampleState_t;

typedef struct
{
    uint16_t connectToPin;
    uint16_t readEnable;
...
typedef struct
{
    ...
    NAFE_drdyPinSeqMode_t drdyPinSeqMode;
} NAFE_sysConfig_t;
...
typedef struct _nafe_hdl NAFE_hdl_t;

typedef void (*afe_transfer_callback_t)(void *data);

struct _nafe_hdl
{
    NAFE_sysConfig_t *sysConfig;
    NAFE_chnConfig_t *chConfig;
    NAFE_HAL_hdl_t *halHdl;
    NAFE_gpioConfig_t *gpioConfig;
    uint32_t devAddr;
    NAFE_readResultFrameMode_t readResultFrameMode;
    volatile NAFE_sampleMode_t devSampleMode;
    NAFE_sampleMode_t sampleMode;
    volatile NAFE_nonBlockSampleState_t nonBlockSampleState; /* For interrupt and DMA approaches.*/
    void *data;                                              /* Result pointer. */
    ...
    uint8_t sampleInProgress;
    afe_transfer_callback_t callback;
    uint8_t useRawData;
};
...
AT_QUICKACCESS_SECTION_CODE(void NAFE_dmaIrqHandle(NAFE_hdl_t *nafeHdl));
