...
#define GOAL_CASSERT_cond(p, l)     enum {GOAL_CASSERT_merge(assertion_failed_, l) = 1 /((int) !!(p))}
...
#  define GOAL_htole24_p(p, x)        GOAL_set_le24_ua((uint8_t *) (p), x)
#  define GOAL_htole32(x)             (x)
#  define GOAL_htole32_p(p, x)        GOAL_set_le32_ua((uint8_t *) (p), x)
#  define GOAL_htole40_p(p, x)        GOAL_set_le40_ua((uint8_t *) (p), x)
#  define GOAL_htole48_p(p, x)        GOAL_set_le48_ua((uint8_t *) (p), x)
#  define GOAL_htole56_p(p, x)        GOAL_set_le56_ua((uint8_t *) (p), x)
...
#  define GOAL_htobe40_p(p, x)        GOAL_set_be40_ua((uint8_t *) (p), x)
#  define GOAL_htobe48_p(p, x)        GOAL_set_be48_ua((uint8_t *) (p), x)
#  define GOAL_htobe56_p(p, x)        GOAL_set_be56_ua((uint8_t *) (p), x)
...
#  define GOAL_le24toh_p(p, x)        GOAL_set_le24_ua((uint8_t *) (p), x)
#  define GOAL_le32toh(x)             (x)
#  define GOAL_le32toh_p(p)           GOAL_get_le32_ua((const uint8_t *) (p))
#  define GOAL_le40toh_p(p)           GOAL_get_le40_ua((const uint8_t *) (p))
#  define GOAL_le48toh_p(p)           GOAL_get_le48_ua((const uint8_t *) (p))
#  define GOAL_le56toh_p(p)           GOAL_get_le56_ua((const uint8_t *) (p))
...
#  define GOAL_be40toh_p(p)           GOAL_get_be40_ua((const uint8_t *) (p))
#  define GOAL_be48toh_p(p)           GOAL_get_be48_ua((const uint8_t *) (p))
#  define GOAL_be56toh_p(p)           GOAL_get_be56_ua((const uint8_t *) (p))
...
#  define GOAL_le16toh_p(p)           GOAL_get_le16_ua((const uint8_t *) (p))
#  define GOAL_le24toh_p(p)           GOAL_get_le24_ua((const uint8_t *) (p))
...
#define GOAL_align_generic(ptr, ptrcast, align)                                           \
    ((ptrcast ptr & (align - 1)) ? (align - (ptrcast ptr & (align - 1))) : 0)

#define GOAL_alignPtr(align, ptr)                                                         \
    (void *) ((PtrCast) ptr + (                                                           \
        (2 == align) ? GOAL_align_2(ptr, (PtrCast)) : (                                   \
        (4 == align) ? GOAL_align_4(ptr, (PtrCast)) : (                                   \
        (8 == align) ? GOAL_align_8(ptr, (PtrCast)) :                                     \
                       GOAL_align_generic(ptr, (PtrCast), align)))))
...
/**< IP address wrapper */
#define GOAL_NET_IPV4(a, b, c, d)   (((unsigned int) a << 24) | (b << 16) | (c << 8) | d)

/* data type casts */
#define GOAL_ROUND_FP_TO_INT32(val)   ((int32_t)((0 < (val)) ? ((val) + 0.5) : ((val) - 0.5)))
#define GOAL_FLOOR_FP_TO_INT32(val)   ((int32_t)(val - 0.5))
#define GOAL_CEIL_FP_TO_INT32(val)    ((int32_t)(val + 0.5))
...
/* time conversion */
#define GOAL_TIME_S_TO_MS(x) ((x) * 1000)       /**< convert time from s to ms */
#define GOAL_TIME_S_TO_US(x) ((x) * 1000000)    /**< convert time from s to us */
#define GOAL_TIME_S_TO_NS(x) ((x) * 1000000000) /**< convert time from s to ns */
#define GOAL_TIME_MS_TO_S(x) ((x) / 1000)       /**< convert time from ms to s */
#define GOAL_TIME_MS_TO_US(x) ((x) * 1000)      /**< convert time from ms to us */
#define GOAL_TIME_MS_TO_NS(x) ((x) * 1000000)   /**< convert time from ms to ns */
#define GOAL_TIME_US_TO_S(x) ((x) / 1000000)    /**< convert time from us to s */
#define GOAL_TIME_US_TO_MS(x) ((x) / 1000)      /**< convert time from us to ms */
#define GOAL_TIME_US_TO_NS(x) ((x) * 1000)      /**< convert time from us to ns */
#define GOAL_TIME_NS_TO_S(x) ((x) / 1000000000) /**< convert time from ns to s */
#define GOAL_TIME_NS_TO_MS(x) ((x) / 1000000)   /**< convert time from ns to ms */
#define GOAL_TIME_NS_TO_US(x) ((x) / 1000)      /**< convert time from ns to ns */
...
#define GOAL_RES_AREA                   0x7fff0000 /**< GOAL result area mask */
...
typedef enum {
    ...
    GOAL_NET_CB_CLOSING_BY_APP,                 /**< callback: closed by application (tunnel channels only) */
    GOAL_NET_CB_SEND_DATA,                      /**< callback: ready to send data (tunnel channels only) */
} GOAL_NET_CB_TYPE_T;
...
typedef GOAL_STATUS_T (*GOAL_NET_CB_T)(
...
typedef struct GOAL_NET_CHAN_T {
    struct GOAL_NET_CHAN_T *pNext;              /**< next net channel */
    struct GOAL_NET_CHAN_T *pChanListener;      /**< Listener that opened data channel */
    GOAL_NET_CB_T callback;                     /**< callback function */
    void *pArg;                                 /**< callback argument */
    GOAL_NET_TYPE_T type;                       /**< channel type */
    void *pData;                                /**< generic data pointer */
    uint32_t flags;                             /**< internal flags of channel */
    GOAL_NET_ADDR_T addr;                       /**< net address */
    uint32_t numDataChannels;                   /**< number of data channels for listener */
} GOAL_NET_CHAN_T;
...
/****************************************************************************/
/** Read a 24 bit value as little endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint32_t GOAL_get_le24_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
...
/****************************************************************************/
/** Write a 24 bit value as little endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_le24_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint16_t x                                  /**< uint16_t value */
)
{
    p8[0] = (uint8_t) (((uint32_t)(x) & (uint16_t) 0x000000ffU));
    p8[1] = (uint8_t) (((uint32_t)(x) & (uint16_t) 0x0000ff00U) >> 8);
    p8[2] = (uint8_t) (((uint32_t)(x) & (uint16_t) 0x00ff0000U) >> 16);
}
...
/****************************************************************************/
/** Read a 40 bit value as big endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint64_t GOAL_get_be40_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
    return ((uint64_t)(
...
/****************************************************************************/
/** Read a 40 bit value as little endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint64_t GOAL_get_le40_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
    return ((uint64_t)(
...
/****************************************************************************/
/** Write a 40 bit value as big endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_be40_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint64_t x                                  /**< uint64_t value */
)
{
    p8[0] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x000000ff00000000ULL) >> 32);
    p8[1] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00000000ff000000ULL) >> 24);
    p8[2] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x0000000000ff0000ULL) >> 16);
    p8[3] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x000000000000ff00ULL) >>  8);
    p8[4] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00000000000000ffULL));
}


/****************************************************************************/
/** Write a 40 bit value as little endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_le40_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint64_t x                                  /**< uint64_t value */
)
{
...
/****************************************************************************/
/** Read a 48 bit value as little endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint64_t GOAL_get_le48_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
    return ((uint64_t)(
...
/****************************************************************************/
/** Write a 48 bit value as little endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_le48_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint64_t x                                  /**< uint64_t value */
)
{
...
/****************************************************************************/
/** Read a 56 bit value as big endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint64_t GOAL_get_be56_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
    return ((uint64_t)(
...
/****************************************************************************/
/** Read a 56 bit value as little endian byte-wise from a pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE uint64_t GOAL_get_le56_ua(
    const uint8_t *p8                           /**< uint8_t pointer */
)
{
    return ((uint64_t)(
...
/****************************************************************************/
/** Write a 56 bit value as big endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_be56_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint64_t x                                  /**< uint64_t value */
)
{
    p8[0] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00ff000000000000ULL) >> 48);
    p8[1] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x0000ff0000000000ULL) >> 40);
    p8[2] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x000000ff00000000ULL) >> 32);
    p8[3] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00000000ff000000ULL) >> 24);
    p8[4] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x0000000000ff0000ULL) >> 16);
    p8[5] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x000000000000ff00ULL) >>  8);
    p8[6] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00000000000000ffULL));
}


/****************************************************************************/
/** Write a 56 bit value as little endian byte-wise to pointer destination
 *
 * ua - (assume) unaligned
 */
static GOAL_TARGET_INLINE void GOAL_set_le56_ua(
    uint8_t *p8,                                /**< uint8_t pointer */
    uint64_t x                                  /**< uint64_t value */
)
{
    ...
    p8[4] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x000000ff00000000ULL) >> 32);
    p8[5] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x0000ff0000000000ULL) >> 40);
    p8[5] = (uint8_t) (((uint64_t)(x) & (uint64_t) 0x00ff000000000000ULL) >> 48);
}
