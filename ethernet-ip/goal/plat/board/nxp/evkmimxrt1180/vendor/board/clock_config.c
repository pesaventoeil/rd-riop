...
- {id: BLK_CTRL_WAKEUPMIX.TMR_1588_REF_CLK_SEL.sel, value: BLK_CTRL_WAKEUPMIX.TMR_1588_REF_CLK_EXT}
...
- {id: BLK_CTRL_WAKEUPMIX.TMR_1588_REF_CLK_EXT.outFreq, value: 240 MHz, enabled: true}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
