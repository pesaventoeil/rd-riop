...
## Remote IO Platform: EtherNet/IP Sample Application
This application showcases the analog and digital I/O features supported by the Remote IO Platform in combination with the EtherNet/IP industrial protocol. The platform communicates over ethernet with CODESYS application running on a PC.<br />
...
Additional SW tools are needed to build, flash and use the application. These are the SEC Tool version 25.09 or newer and CODESYS.
...
## 3. Release Notes<a name="step3"></a>
